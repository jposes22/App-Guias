package es.server.java.baronha.service.generic.impl;
...
import es.server.java.baronha.model.generic.DaoBase;
import es.server.java.baronha.service.converter.GenericConverter;
import es.server.java.baronha.service.generic.ServiceBase;
