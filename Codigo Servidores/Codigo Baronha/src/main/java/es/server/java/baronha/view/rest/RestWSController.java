package es.server.java.baronha.view.rest;
...
import es.server.java.baronha.service.guia.GuiaService;
...
import es.server.java.baronha.service.poi.POIService;
import es.server.java.baronha.utilidades.constantes.ConstantesServer;
import es.server.java.baronha.utilidades.generic.Generic;
import es.server.java.baronha.view.dto.DescargableDTO;
