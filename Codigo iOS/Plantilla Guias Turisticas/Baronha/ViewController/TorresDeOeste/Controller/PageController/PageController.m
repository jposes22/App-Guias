...
-(void)initPageController{
    ...
    SlideGuide *initialViewController = [self viewControllerAtIndex:0];
...
- (SlideGuide *)viewControllerAtIndex:(NSUInteger)index {
    
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Guias" bundle:nil];
    SlideGuide *childViewController = [storyboard instantiateViewControllerWithIdentifier:@"SlideGuide"];
...
- (UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    NSUInteger index = [(SlideGuide *)viewController index];
