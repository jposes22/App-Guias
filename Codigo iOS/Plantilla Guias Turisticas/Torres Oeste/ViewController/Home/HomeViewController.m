...
-(void)loadData{
    ...
    [self.btnRomeria setTitle:NSLocalizedString(@"menu_como_romeria", nil) forState:UIControlStateNormal];
    [self.btnComoLlegar setTitle:NSLocalizedString(@"menu_como_llegar", nil) forState:UIControlStateNormal];
    [self.btnTorresOeste setTitle:NSLocalizedString(@"menu_como_torres", nil) forState:UIControlStateNormal];
    [self.btnLugaresInteres setTitle:NSLocalizedString(@"menu_lugares", nil) forState:UIControlStateNormal];
}
-(void)loadStyle{
